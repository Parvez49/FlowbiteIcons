    ...
    return (
        <div className="min-w-[260px] lg:mr-5 mb-3 lg:mb-0">
            <div className="w-full flex justify-between items-center">
                <label className="text-sm font-medium text-gray-900 dark:text-gray-300 text-sm font-medium !text-gray-600 dark:!text-gray-400" data-testid="flowbite-label" for="icon-size">{title}</label>
