    ...
    <div className="px-4 mx-auto max-w-7xl">
      ...
      <div class="mb-4">
        <form
          ...
          class="seva-form formkit-form flex max-w-xl md:mx-auto"
          method="post"
          ...
          <div class="w-full" data-style="clean">
            ...
            <div class="relative h-full">
              ...
              <input
                ...
                id="member_email"
                name="email_address"
                class="block w-full px-3 py-4 pl-11 text-base text-gray-900 bg-white border border-gray-200 rounded-l-xl formkit-input focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder:text-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
